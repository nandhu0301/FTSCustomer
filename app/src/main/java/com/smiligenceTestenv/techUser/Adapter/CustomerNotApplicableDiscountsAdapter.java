...
public class CustomerNotApplicableDiscountsAdapter extends BaseAdapter {

    private Context mcontext;
    private List<Discount> discountList;
    LayoutInflater inflater;

    public CustomerNotApplicableDiscountsAdapter(Context context, List<Discount> listDiscount) {
        mcontext = context;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        CustomerNotApplicableDiscountsAdapter.ViewHolder holder = new ViewHolder();
        if (row == null) {
            ...
            holder = (CustomerNotApplicableDiscountsAdapter.ViewHolder) row.getTag();
        }
